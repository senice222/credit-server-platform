...
export const createAdmin = async (req, res) => {
    const { login, access, comment, password, superAdmin, modulesAccess } = req.body
    const access2 = req.super
...
export const changeAdmin = async (req, res) => {
    const { id } = req.params
    const { access, fio, comment, password, superAdmin, modulesAccess } = req.body
    const access2 = req.super
    ...
    user.access = access
    user.modulesAccess = modulesAccess
